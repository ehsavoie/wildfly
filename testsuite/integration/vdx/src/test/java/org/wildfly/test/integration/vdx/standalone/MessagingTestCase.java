...
public class MessagingTestCase extends TestBase {
    ...
    */
    ...
    public void testWrongOrderOfElements() throws Exception {
        ...
        assertContains(errorLog, "Elements allowed here are:");
        assertContains(errorLog, "acceptor                   journal-thread-pool");
        ...
        assertContains(errorLog, "broadcast-group            paging-directory");
        assertContains(errorLog, "cluster-connection         pooled-connection-factory");
        assertContains(errorLog, "connection-factory         queue");
        assertContains(errorLog, "connector                  remote-acceptor");
        assertContains(errorLog, "connector-service          remote-connector");
        assertContains(errorLog, "discovery-group            replication-colocated");
        assertContains(errorLog, "divert                     replication-master");
        assertContains(errorLog, "grouping-handler           replication-slave");
        assertContains(errorLog, "http-acceptor              scheduled-thread-pool");
        ...
        assertContains(errorLog, "jms-topic                  thread-pool");
        assertContains(errorLog, "journal-directory          ");
